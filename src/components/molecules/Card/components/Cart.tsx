...
const transitionStyles = {
  ...
  exiting: { transform: "translate(-1000px)" },
  exited: { transform: "translate(-1000px)" },
      ...
      <Transition in={isReady} timeout={400}>
        {(state) => (
          <div
            ...
            ref={nodeRef}
            className={clsx("w-full", !isReady ? "absolute opacity-0" : "relative")}
          >
            <div className={clsx("w-full")}>
              <div className='flex relative flex-col sm:flex-row'>
                <div className='h-fit mr-4 max-w-[100px] sm:max-w9-[120px] relative w-full shrink-0 flex items-stretch '>
                  <div className='rounded-lg shrink-0 overflow-hidden transition duration-300 ease-in-out w-full'>
                    <Image {...thumbnail} ratio={[3, 4]} onLoad={() => setIsReady(true)} />
                  </div>
                  {quantity && (
                    <div className='rounded-[32px] min-w-[22px] absolute lef-[-4px] top-[-4px]'>
